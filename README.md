...
# Hardware
The CP07 controller communicates with the ATREA RK2 heat recovery unit via the LIN bus. It communicates at 300 Bauds and each packet has 10 bytes. The CP07 driver sends a query to the Atrea unit (the type is in bytes 2 and 3) and receives a response from Atrea. For the connection use a LIN bus interface [TTL UART to LIN Can Bus Converter](https://www.aliexpress.com/item/4001054538389.html) or maybe [UART to LIN Bus Module](https://www.aliexpress.com/item/1005002376896294.html) and an ESP8266 module WeMos D1 mini, which is connected in parallel to the CP07 driver line. If the program detects the presence of the CP07 driver in the ESP8266 after startup, it will only listen to the ATREA system status. If the driver is not present, the module will take over its function. The CP07 driver is still required to configure the unit, but can be disconnect after setup ATREA.
...
### heating season, not heating 
    off ventilation
      ...
      [ATREA]: F5 00 01 00 00 00 3D 48 FB EC    flaps 0 odpovídá 01 
    medium ventilation
      [CP-07]: F5 00 01 02 08 02 01 02 00 F6 
      [ATREA]: F5 00 01 08 01 00 3D 48 FB 80    flaps 0
    max ventilation
      [CP-07]: F5 00 01 04 08 02 01 02 00 44 
      [ATREA]: F5 00 01 08 02 00 3D 48 FB CE    flaps 0 
    max shock ventilation
      [CP-07]: F5 00 01 04 08 02 01 02 00 44 
      [ATREA]: F5 00 01 08 12 00 3D 49 FB 76    flaps 0 
  ### heating season, heating 
    off ventilation
      [CP-07]: F5 00 01 01 08 02 01 03 00 6B 
      [ATREA]: F5 00 01 00 00 00 3D 58 FB 00    flaps 0 
    medium ventilation -> (change to max)
    max ventilation
      [CP-07]: F5 00 01 04 08 02 01 03 00 80 
      [ATREA]: F5 00 01 08 0A 00 3D 5E FB B6    flaps 0 
    medium shock ventilation WC
      [CP-07]: F5 00 01 02 08 02 01 03 00 32 
      [ATREA]: F5 00 01 08 19 00 3D 49 FB 06    flaps 0 
    medium shock ventilation kitchen
      [CP-07]: F5 00 01 02 08 02 01 03 00 32 
      [ATREA]: F5 00 01 08 19 00 3D 49 FB 06    flaps 0 
    max shock ventilation kitchen
      [CP-07]: F5 00 01 04 08 02 01 03 00 80 
      [ATREA]: F5 00 01 10 1A 00 3D 5B FB CF    flaps 0 
...
### heating season, not heating
    off ventilation
      ...
      [ATREA]: F5 00 01 00 20 00 3D 4C FB 2F    flaps 1 odpovida 02 
    medium ventilation
      [CP-07]: F5 00 01 02 04 02 02 02 00 33 
      [ATREA]: F5 00 01 04 20 00 3C 4B FB 36    flaps 1 
    ...
    medium / max shock ventilation
      ...
      [ATREA]: F5 00 01 04 32 00 3D 57 FB C3    flaps 1 
### heating season, heating
    off ventilation
      [CP-07]: F5 00 01 01 04 02 02 03 00 AE 
      [ATREA]: F5 00 01 00 20 00 3D 58 FB F8    flaps 1 
    medium ventilation
      [CP-07]: F5 00 01 02 04 02 02 03 00 F7 
      [ATREA]: F5 00 01 04 29 00 3D 57 FB CF    flaps 1 
    max ventilation
      [CP-07]: F5 00 01 04 04 02 02 03 00 45 
      [ATREA]: F5 00 01 04 2A 00 3D 55 FB 10    flaps 1 
    max shock ventilation
      [CP-07]: F5 00 01 04 04 02 02 03 00 45 
      [ATREA]: F5 00 01 04 3A 00 3D 55 FB 6C    flaps 1 
...
### heating season, not heating
    off ventilation
      ...
      [ATREA]: F5 00 01 00 00 00 3C 4C FB 7C    flaps 0 
    medium ventilation
      [CP-07]: F5 00 01 02 04 02 01 02 00 D7 
      [ATREA]: F5 00 01 04 01 00 3C 4C FB 6D    flaps 0 
    max ventilation
      [CP-07]: F5 00 01 04 04 02 01 02 00 65 
      [ATREA]: F5 00 01 04 02 00 3C 4B FB 4D    flaps 0 
    medium shock ventilation
      [CP-07]: F5 00 01 02 04 02 01 02 00 D7 
      [ATREA]: F5 00 01 04 11 00 3D 4A FB 10    flaps 0
### heating season, heating
    off ventilation
      [CP-07]: F5 00 01 01 04 02 01 03 00 4A 
      [ATREA]: F5 00 01 00 00 00 3C 5B FB FE    flaps 0 
    medium ventilation
      [CP-07]: F5 00 01 02 04 02 01 03 00 13 
      [ATREA]: F5 00 01 04 09 00 3C 59 FB 40    flaps 0 
    max ventilation
      [CP-07]: F5 00 01 04 04 02 01 03 00 A1 
      [ATREA]: F5 00 01 04 0A 00 3C 58 FB CA    flaps 0 
    medium shock ventilation (sometimes set max inensity)
      [CP-07]: F5 00 01 02 04 02 01 03 00 13 
      [ATREA]: F5 00 01 04 19 00 3D 4A FB 2E    flaps 0 
...
### operating mode cooling, not heating season
    cooling off
      [CP-07]: F5 00 01 *02 01 02 02 00 00 70    ovìøit !
      [ATREA]: F5 00 01 05 20 00 3D 43 FB DC    flaps 1
    medium cooling
      [CP-07]: F5 00 01 02 01 02 02 01 00 B4
      [ATREA]: F5 00 01 05 21 00 3D 42 FB D5    flaps 1
    max cooling
      [CP-07]: F5 00 01 04 01 02 02 01 00 06
      [ATREA]: F5 00 01 05 22 00 3D 49 FB B8    flaps 1
    shock ventilation + cooling
      [CP-07]: F5 00 01 *02 01 02 02 01 00 B4    ovìøit !
      [ATREA]: F5 00 01 *01 31 00 3D 41 FB 20    flaps 1
...
- 0xF5 0x00 0x01 [intensity 1,2,4] [mode 1,2,4,8,16] [m2] [m3 0,1,2,3] [m4 0,1,2] 0x00 [crc]
    - intensity is 1=off, 2=medium or 4=max
    - modes:
        - pressure ventilation: mode = 1, m2 = 2, m3 = 1, m4 = 0
        - circulation dependent: mode = 2, m2 = 2, m3 = 2, m4 = 3 or 0
        - circulation: mode = 4, m2 = 2, m3 = 1, m4 = 3 or 0
        - circulation ventilation: mode = 8, m2 = 1, m3 = 1, m4 = 3 or 2 (0 in summer)
        - equal pressure ventilation (not heating season): mode = 0x10, m2 = 2, m3 = 1, m4 = 0
        - equal pressure ventilation (heating season, not heating): mode = 0x10, m2 = 2, m3 = 1, m4 = 2
        - equal pressure ventilation (heating season, heating): mode = 0x10, m2 = 2, m3 = 1, m4 = 3
        - cooling (not cooling): mode = 1, m2 = 2, m3 = 2, m4 = 0
        - cooling (cooling): mode = 1, m2 = 2, m3 = 2, m4 = 1
...
- 0xF5 0x00 0x01 [mode 0,1,2,4,5,8,16] [flags: intensity [0,1,2], errorB 0x04, heating 0x08, shock vent. 0x10, ? 0x20] [errors] [TE] [TA] x [crc]
    - modes:
        - nothing: mode = 0, flags = 0 or 0x20
            - value 0x20 of flags possibly means opening of the flaps
...
- 0xF5 x x [intensity] [mode] [m2] [m3] [m4] 0x00 [crc]
  
The responds packets from the ATREA unit to the CP07 controller:
- 0xF5 0x00 0x01 [mode] [intensity, errorB, heating, shock vent., ?] [errors] [TE] [TA] x [crc]
